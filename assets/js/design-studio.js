(function(){
 ...
 function open(item){
  ...
  root.innerHTML='<div class="modal" style="width:min(1100px,96vw);max-height:94vh;overflow:auto" dir="rtl">'+
   ...
   '<label>بداية الـFade: <output data-value="fadeStartY">760</output> بكسل<input type="range" data-field="fadeStartY" min="500" max="1000" step="5" value="760"></label>'+
   '<label>نهاية الـFade: <output data-value="fadeEndY">905</output> بكسل<input type="range" data-field="fadeEndY" min="550" max="1120" step="5" value="905"></label><p>حرّك بداية ونهاية التلاشي لتحكم مساحة ظهور الصورة. النهاية تتوقف قبل الفوتر.</p>'+
