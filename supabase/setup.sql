...
create table if not exists public.patient_physio_reports (
  ...
  -- تشخيص الحالة بشكل عام (منفصل عن تحديد نقط الـ area على الرسم)
  diagnosis        text not null default '',
  -- نقاط الألم على الرسم التوضيحي — [{x, y, side, note}, ...] (x/y نسبة مئوية) — مرقمة بترتيب الإضافة
...
alter table public.patient_physio_reports add column if not exists diagnosis text not null default '';
...
-- ============================================================
-- قسم ٥٧: متابعة المريض — موعد بتوقيت، تأجيل ورسالة للمريض
-- ============================================================
...
-- ============================================================
-- 50) Video Worker Reliability — heartbeat, stale-job recovery, and safe status
-- ============================================================
...
-- ============================================================
-- 51) Video Job Progress — dashboard stage bar
-- ============================================================
alter table public.video_jobs
...
-- AI design routing, manual final approval retained.
begin;
