...
**المراحل الجاية**: تصميم واجهة موحّدة (قائمة منسدلة) لأرشيف المرضى/إدارة
الليدز مطابقة لشريط SSMPD العلوي، زرار رفع/تنزيل مستقل لكل تصنيف مستند في
أرشيف المرضى، شاشة "تغيير كلمة السر" → اختبار شامل إضافي على الموبايل →
مراجعة نهائية مع المستخدم لموديولي أرشيف المرضى وإدارة الليدز →
التحليلات المستقبلية لو اتطلبت.
